# apato_083_sazon3_fase1BB.py



# apato_083_sazon3_fase1BB - versão multi-cliente
...
# ============================================================
# 1) Carregar tb_sazon3BB e tb_sazon1BBB
# ============================================================

df_sazon3BB = conn.execute("""
    SELECT * FROM tb_sazon3BB ORDER BY sku, ordem
""").fetchdf()

df_sazon1BBB = conn.execute("""
    SELECT sku FROM tb_sazon1BBB ORDER BY id_reg
""").fetchdf()
...
for sku in df_sazon1BBB['sku']:
    df_sku = df_sazon3BB[df_sazon3BB['sku'] == sku].sort_values('ordem')
...
print("tb_sazon3BB atualizada com sucesso (equivalente ao sp8_sazon3_fase1BB).")
