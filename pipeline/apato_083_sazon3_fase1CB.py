# apato_083_sazon3_fase1CB.py


# apato_083_sazon3_fase1CB - versão multi-cliente
...
# ============================================================
# 1) Carregar tb_sazon3CB e tb_sazon1BCB
# ============================================================

df_sazon3CB = conn.execute("""
    SELECT * FROM tb_sazon3CB ORDER BY sku, ordem
""").fetchdf()

df_sazon1BCB = conn.execute("""
    SELECT sku FROM tb_sazon1BCB ORDER BY id_reg
""").fetchdf()
...
for sku in df_sazon1BCB['sku']:
    df_sku = df_sazon3CB[df_sazon3CB['sku'] == sku].sort_values('ordem')
...
print("tb_sazon3CB atualizada com sucesso (equivalente ao sp8_sazon3_fase1CB).")
