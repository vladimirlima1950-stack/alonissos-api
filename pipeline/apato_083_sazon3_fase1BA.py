# apato_083_sazon3_fase1BA.py


# apato_083_sazon3_fase1BA - versão multi-cliente
...
# ============================================================
# 1) Carregar tb_sazon3BA e tb_sazon1BBA
# ============================================================

df_sazon3BA = conn.execute("""
    SELECT * FROM tb_sazon3BA ORDER BY sku, ordem
""").fetchdf()

df_sazon1BBA = conn.execute("""
    SELECT sku FROM tb_sazon1BBA ORDER BY id_reg
""").fetchdf()
...
for sku in df_sazon1BBA['sku']:
    df_sku = df_sazon3BA[df_sazon3BA['sku'] == sku].sort_values('ordem')
...
print("tb_sazon3BA atualizada com sucesso (equivalente ao sp8_sazon3_fase1BA).")
