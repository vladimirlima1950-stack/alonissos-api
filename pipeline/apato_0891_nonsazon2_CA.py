# apato_0891_nonsazon2_CA.py
# Equivalente 100% ao MySQL sp8_A_nonsazon2_CA



# apato_0891_nonsazon2_CA - versão multi-cliente
# Equivalente 100% ao MySQL sp8_A_nonsazon2_CA
...
def apato_0891_nonsazon2_CA(pasta_cliente):
    ...
    try:
        # Consulta equivalente ao filtro C/A
        query = """
            SELECT 
                t2.sku,
                t2.x_ordem,
        ...
        if df.empty:
            print("Nenhum SKU encontrado para classe C/A.")
            return
        ...
        con.execute("DROP TABLE IF EXISTS tb_A_trend3_somas_e_medias_fase1_CA")
        con.register("df_final_CA", res)
        con.execute("""
            CREATE TABLE tb_A_trend3_somas_e_medias_fase1_CA AS
            SELECT * FROM df_final_CA
        """)

        print("apato_0891_nonsazon2_CA executado com sucesso — versão Pandas/Numpy equivalente ao MySQL.")
...
if __name__ == "__main__":
    ...
    apato_0891_nonsazon2_CA(pasta_cliente)
