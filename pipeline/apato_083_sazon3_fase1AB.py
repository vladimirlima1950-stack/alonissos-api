# apato_083_sazon3_fase1AB.py





# apato_083_sazon3_fase1AB - versão multi-cliente
...
# ============================================================
# 1) Carregar tb_sazon3AB e tb_sazon1BAB
# ============================================================

df_sazon3AB = conn.execute("""
    SELECT * FROM tb_sazon3AB ORDER BY sku, ordem
""").fetchdf()

df_sazon1BAB = conn.execute("""
    SELECT sku FROM tb_sazon1BAB ORDER BY id_reg
""").fetchdf()
...
for sku in df_sazon1BAB['sku']:
    df_sku = df_sazon3AB[df_sazon3AB['sku'] == sku].sort_values('ordem')
...
print("tb_sazon3AB atualizada com sucesso (equivalente ao sp8_sazon3_fase1AB).")
