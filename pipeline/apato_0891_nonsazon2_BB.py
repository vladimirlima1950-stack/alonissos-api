# apato_0891_nonsazon2_BB.py
# Equivalente 100% ao MySQL sp8_A_nonsazon2_BB



# apato_0891_nonsazon2_BB - versão multi-cliente
# Equivalente 100% ao MySQL sp8_A_nonsazon2_BB
...
def apato_0891_nonsazon2_BB(pasta_cliente):
    ...
    try:
        # Consulta equivalente ao filtro B/B
        query = """
            SELECT 
                t2.sku,
                t2.x_ordem,
        ...
        if df.empty:
            print("Nenhum SKU encontrado para classe B/B.")
            return
        ...
        con.execute("DROP TABLE IF EXISTS tb_A_trend3_somas_e_medias_fase1_BB")
        con.register("df_final_BB", res)
        con.execute("""
            CREATE TABLE tb_A_trend3_somas_e_medias_fase1_BB AS
            SELECT * FROM df_final_BB
        """)

        print("apato_0891_nonsazon2_BB executado com sucesso — versão Pandas/Numpy equivalente ao MySQL.")
...
if __name__ == "__main__":
    ...
    apato_0891_nonsazon2_BB(pasta_cliente)
