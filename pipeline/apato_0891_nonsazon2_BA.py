# apato_0891_nonsazon2_BA.py
# Equivalente 100% ao MySQL sp8_A_nonsazon2_BA



# apato_0891_nonsazon2_BA - versão multi-cliente
# Equivalente 100% ao MySQL sp8_A_nonsazon2_BA
...
def apato_0891_nonsazon2_BA(pasta_cliente):
    ...
    try:
        # Consulta equivalente ao filtro B/A
        query = """
            SELECT 
                t2.sku,
                t2.x_ordem,
        ...
        if df.empty:
            print("Nenhum SKU encontrado para classe B/A.")
            return
        ...
        con.execute("DROP TABLE IF EXISTS tb_A_trend3_somas_e_medias_fase1_BA")
        con.register("df_final_BA", res)
        con.execute("""
            CREATE TABLE tb_A_trend3_somas_e_medias_fase1_BA AS
            SELECT * FROM df_final_BA
        """)

        print("apato_0891_nonsazon2_BA executado com sucesso — versão Pandas/Numpy equivalente ao MySQL.")
...
if __name__ == "__main__":
    ...
    apato_0891_nonsazon2_BA(pasta_cliente)
