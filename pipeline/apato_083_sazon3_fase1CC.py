# apato_083_sazon3_fase1CC.py


# apato_083_sazon3_fase1CC - versão multi-cliente
...
# ============================================================
# 1) Carregar tb_sazon3CC e tb_sazon1BCC
# ============================================================

df_sazon3CC = conn.execute("""
    SELECT * FROM tb_sazon3CC ORDER BY sku, ordem
""").fetchdf()

df_sazon1BCC = conn.execute("""
    SELECT sku FROM tb_sazon1BCC ORDER BY id_reg
""").fetchdf()
...
for sku in df_sazon1BCC['sku']:
    df_sku = df_sazon3CC[df_sazon3CC['sku'] == sku].sort_values('ordem')
...
print("tb_sazon3CC atualizada com sucesso (equivalente ao sp8_sazon3_fase1CC).")
