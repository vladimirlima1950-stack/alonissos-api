...
// CONSULTA AO BANCO
// ============================================================
$sql = "SELECT class_abc_pedidos, class_abc_valores, sku, es_mes_corrente, es_corr_mais1, es_corr_mais2,
               es_corr_mais3, es_corr_mais4, es_corr_mais5, es_corr_mais6, es_corr_mais7, es_corr_mais8,
...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    foreach ($campos as $campo) {
        ...
        // Formatação numérica
        if (strpos($campo, 'es_') === 0 && is_numeric($valor)) {
...
// ============================================================
$filePath = $pasta_saida . "/tabela_estoques_segurança.xlsx";
...
file_put_contents('C:\xampp\php\logs\php_error_log', "Final de alon_prev_gera_plan_tb_estoques_segurança.php\n", FILE_APPEND);
